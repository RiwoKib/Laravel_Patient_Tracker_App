        ...
        <aside class="z-20 flex-shrink-0 h-screen hidden w-64 overflow-y-auto bg-slate-800 md:block">
            ...
            <div class="flex flex-col px-4 py-4 text-gray-400 text-md space-y-3 font-medium">
                <a href="" class="flex">
                    ...
                    <a href="" class="flex hover-text-gray-200 space-x-2">Calendar</a>
                    <a href="" class="flex hover-text-gray-200 space-x-2">Documents</a>
                    <a href="" class="flex hover-text-gray-200 space-x-2">
                        <span>Reports</span>
                    </a>
                    <a href="" class="flex hover-text-gray-200 space-x-2">
                        <span>Settings</span>
                ...
                <div class="grid grid-cols-1 md:cols-2 lg:grid-cols-4 gap-4 lg:gap-8">
                    ...
                    <div class="p-4 bg-white rounded-lg shadow-sm lg:col-span-3">
                        <div class="rounded-lg">
                            <div class="flex-1 b-gray-50">Dose/Payment Bar Graph</div>
