                ...
                <section class=" py-1 bg-blueGray-50">
                    <div class="w-full lg:w-8/12 px-4 mx-auto mt-6">
                        ...
                        <div class="rounded-t bg-white mb-0 px-6 py-6">
                            ...
                            <button class="bg-cyan-500 text-white active:bg-slate-400 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none hover:bg-cyan-700 focus:outline-none mr-1 ease-linear transition-all duration-150" type="submit">
                                Administer Dose 1
                            </button>
                            </div>
                        </div>
