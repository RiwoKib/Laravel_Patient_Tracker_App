    ...
    <section class="flex">
        ...
        <main class="bg-slate-200 h-screen w-full overflow-scroll">
            <div class="p-8">
                ...
                <div class="py-5">
                    <h1 class="text-xl font-bold">Administer Dose 3</h1>
                    <p class="text-sm text-red-400"><i class="fa fa-times"></i> Not Delivered</p>
                </div>
                ...
                {{-- DOSE 3 PATIENTS TABLE SECTION --}}
                <div class="py-5">
                    <h1 class="text-xl font-bold">Pending Dose 3 Patients</h1>
